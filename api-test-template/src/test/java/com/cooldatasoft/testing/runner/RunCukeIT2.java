...
@CucumberOptions(
        ...
        , glue = "com.cooldatasoft.testing.stepdefs.core.scenario2"
        , features = "src/test/resources/features/TestTemplate2.feature"
        , monochrome = true
)
public class RunCukeIT2 extends AbstractTestNGCucumberTests {
